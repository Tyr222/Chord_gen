...
Google Magenta (html-midi-player): Web/JavaScript component injected into the code to synthesize and play the audio on the client side without needing external software.
